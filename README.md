...
> _Screenshots coming soon._ Drop images into a `docs/` folder and reference them here, e.g.
...
- **Duplicate Finder** — size → partial-hash (first 64 KB) → full XxHash128 pipeline; keeps at least one
