...
public partial class RepairToolkitPage : Page
{
    private readonly RepairToolkitViewModel _viewModel;

    public RepairToolkitPage(RepairToolkitViewModel viewModel)
    {
